...
//   console.log(exchangeRate);
  ...
  currency_1.innerText = `1 ${exchangeFrom.toUpperCase()} = ${exchangeRate.toFixed(2)} ${exchangeTo.toUpperCase()}`;

  currency_2.innerText = `1 ${exchangeTo.toUpperCase()} = ${(1 / exchangeRate).toFixed(2)} ${exchangeFrom.toUpperCase()}`;
  amountEntered.value = "";
};
